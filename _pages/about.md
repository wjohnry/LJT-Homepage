...
I am Junteng Liu (刘俊腾), a first-year PhD candidate at the [HKUST NLP Group](https://hkust-nlp.github.io/), advised by Prof. Junxian He. I graduated from Shanghai Jiao Tong University (SJTU) in June 2024, where I was also previously advised by Prof. Junxian He during my undergraduate studies.
...
Publications
======
(* indicates equal contribution / first-author work where I am the first author)
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**
   ...
   <br>Arxiv, 2025. (Code: [Vision4Chart](https://github.com/Vicent0205/Vision4Chart))

3. **On the Universal Truthfulness Hyperplane Inside LLMs**
   <br>**Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He
   <br>EMNLP 2024. (Code: Universal_Truthfulness_Hyperplane)
